...
public class Solution {
    // Changed method name from alienOrder to foreignDictionary to match the test runner
    public String foreignDictionary(String[] words) {
        ...
        // If the processed string doesn't contain all unique characters, a cycle exists
